...
require (
	...
	tailscale.com v1.1.1-0.20220330175050-9f604f2bd3b4
)
...
require (
	...
	github.com/tailscale/golang-x-crypto v0.0.0-20220330002111-62119522bbcf // indirect
	...
	gvisor.dev/gvisor v0.0.0-20220318082524-536b85ae1a6a // indirect
